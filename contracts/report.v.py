Report: event({_from: indexed(address), _latitude: uint256, _longitude: uint256, _content: bytes32})
...
@public
def inputReport(_latitude: uint256, _longitude: uint256, _content: bytes32):
